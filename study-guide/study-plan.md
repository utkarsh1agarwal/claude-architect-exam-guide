...
9. [Mock Exam A](../mock-exam/exam-a-questions.md) — 60 questions, timed, all 6 scenarios; then [Exam B](../mock-exam/exam-b-questions.md) and [Exam C](../mock-exam/exam-c-questions.md) for realistic 4-of-6 draws
...
| 4 | Domain 5 (Context & Reliability) + review | Read the domain file. Re-read the [Cheat Sheet](cheat-sheet.md). Take [Mock Exam A](../mock-exam/exam-a-questions.md) untimed first, then [Exam B](../mock-exam/exam-b-questions.md)/[C](../mock-exam/exam-c-questions.md) timed on separate days in the run-up to your exam date. |
...
| 8 | Mock exam | Take [Mock Exam A](../mock-exam/exam-a-questions.md) timed, 120 minutes, no notes. Score against the [Answer Key](../mock-exam/exam-a-answers.md). If time allows, [Exam B](../mock-exam/exam-b-questions.md) or [C](../mock-exam/exam-c-questions.md) makes a good second timed run for a more realistic 4-of-6 draw. |
...
- **Day 2 (or final hours):** Take [Mock Exam A](../mock-exam/exam-a-questions.md) timed. Use every wrong answer to speed-read the relevant domain section. Re-skim the cheat sheet once more before your appointment.
